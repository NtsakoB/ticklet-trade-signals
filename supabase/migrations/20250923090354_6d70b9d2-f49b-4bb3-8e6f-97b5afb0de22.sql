-- Insert sample trading signals matching the expected dashboard data
INSERT INTO public.signals (
  symbol, side, entry_price, stop_loss, targets, confidence, strategy, status, ai_summary
) VALUES
-- BUY TRXUSDT (from screenshot)
('TRXUSDT', 'BUY', 0.347000, 0.336590, 
