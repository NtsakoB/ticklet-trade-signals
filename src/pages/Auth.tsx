  ...
  return (
    <div className="bg-[#0f172a] text-white h-screen flex flex-col items-center justify-center">
      ...
      <div className="bg-[#1e293b] p-6 rounded-lg max-w-md">
        <h2 className="text-xl mb-4">🔧 Auth temporarily disabled</h2>
        <p className="text-gray-400 text-sm">
          Authentication has been commented out to allow AI testing and routing logic preview. 
          Restore this file to enable login.
        </p>
      </div>
    </div>
  );
