...
# Map these imports to your real strategy functions:
try:
...
STRATEGY_CONFIG = {
    "TickletAlpha": {"symbols": "auto", "timeframes": ["15m","30m","1h","1d"]},
    "GoldenHook":   {"symbols": "auto", "timeframes": ["15m","1h","1d"]},
    "MarketRegime": {"symbols": "auto", "timeframes": ["1h","1d"]},
}
