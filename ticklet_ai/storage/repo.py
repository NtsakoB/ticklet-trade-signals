...
ACTIONS_HEADER = [
  "ts_utc","event","symbol","strategy","timeframe","details"
]

def _sb() -> Optional[Client]:
    url = os.getenv("TICKLET_SUPABASE_URL") or os.getenv("SUPABASE_URL") or ""
    key = os.getenv("TICKLET_SUPABASE_ANON_KEY") or os.getenv("SUPABASE_KEY") or ""
